...
func remnawave274Catalog() []Route {
	...
	overrides := []Route{
		...
		{Name: "user.list", Method: http.MethodGet, Pattern: "/api/users", Support: PolicyEnforced, Scopes: []string{"users:read"}, QueryAllowed: []string{"page", "size", "limit", "offset", "start", "search", "username", "includeHwid", "includeSubscription", "filters", "filterModes", "sorting"}, Group: "users"},
